        ...
        {files.map((file) => {
          ...
          return (
            ...
            >
              ...
              <div className="w-12 h-12 sm:w-16 sm:h-16 mb-1 sm:mb-2 flex items-center justify-center rounded-md border-2 border-gray-300 bg-white shadow-sm transition-colors">
                <Icon className="w-6 h-6 sm:w-8 sm:h-8 text-gray-900 cursor-pointer" />
              </div>
              
              {/* Responsive text size with cream background */}
              <span className="text-fluid-xs sm:text-fluid-sm font-medium text-center max-w-full truncate text-gray-900 bg-[#F0DFCA] px-2 py-1 cursor-pointer">
                {file.name}
              </span>
            </button>
          );
